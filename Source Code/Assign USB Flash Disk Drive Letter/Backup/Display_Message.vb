...
#Region " Windows Form Designer generated code "
    ...
    Public Sub New(ByVal display As String)
        ...
        'Add any initialization after the InitializeComponent() call
        Label1.Text = display
        Label1.Select(Label1.Text.Length, 0)
    End Sub
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Label1.Size = New System.Drawing.Size(303, 160)
        ...
        Me.MaximumSize = New System.Drawing.Size(320, 232)
        Me.MinimizeBox = False
        Me.MinimumSize = New System.Drawing.Size(320, 232)
...
#End Region
    ...
    Private Sub Display_Message_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            elapsed = 0
            Label2.Text = "Closing in " & (20 - elapsed).ToString & " secs"
            Timer1.Start()
        Catch ex As Exception
